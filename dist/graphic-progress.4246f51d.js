...
},{"./lib/parse-font":"../node_modules/canvas/lib/parse-font.js"}],"images/zoom1.jpg":[function(require,module,exports) {
module.exports = "/zoom1.0865a67e.jpg";
},{}],"images/zoom2.jpg":[function(require,module,exports) {
module.exports = "/zoom2.060863a2.jpg";
},{}],"images/zoom3.jpg":[function(require,module,exports) {
module.exports = "/zoom3.4dee83ce.jpg";
},{}],"images/zoom4.jpg":[function(require,module,exports) {
module.exports = "/zoom4.173a72dd.jpg";
},{}],"graphic-progress.js":[function(require,module,exports) {
"use strict";
...
(function () {
  var width = 1000;
  var height = 800;
  var canvas = d3.select('#graphic').append('canvas').attr('width', width).attr('height', height);
  var context = canvas.node().getContext('2d');
  var projection = d3.geoMercator().scale(1000).translate([width / 2, height / 2]);
  var path = d3.geoPath().projection(projection); // You'll need to georeference the top left and bottom right of each image
  ...
  var loadImages = Promise.all(layers.map(function (d) {
    return new Promise(function (resolve, reject) {
      var image = new Image();
  ...
  function ready() {
    labelText.forEach(function (d) {
      d.coords = eval(d.loc);
    });
    var labelHolder = d3.select(canvas.node().parentNode).style('position', 'relative').append('div').style('position', 'absolute').style('top', 0).style('left', 0).style('height', height + 'px').style('width', width + 'px').style('overflow', 'hidden').attr('class', 'label-holder');
    var labels = labelHolder.selectAll('div').data(labelText).enter().append('div').style('transform', function (d) {
      if (d.rotation) {
      ...
      var layerClasses = d.visibleAt.split(', ').map(function (d) {
        return 'label-for-' + d;
      }).join(' ');
      return ['map-label', d.class, layerClasses].join(' ');
    }).style('position', 'absolute').style('text-align', function (d) {
      return d.align;
    });

    function positionLabels() {
      labels.style('top', function (d) {
        return projection(d.coords)[1] + 'px';
      }).style('left', function (d) {
        return projection(d.coords)[0] + 'px';
      });
    }

    function drawWaypoint(slug) {
      var progress = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      currentWaypointSlug = slug;
      var index = waypoints.findIndex(function (d) {
        return d.slug === slug;
      });
      var waypoint0 = waypoints[index];
      var waypoint1 = waypoints[index + 1];
      ...
      var zoom = d3.interpolateNumber(waypoint0.zoom, waypoint1.zoom)(d3.easeQuad(progress));
      var focus = [d3.interpolateNumber(waypoint0.focus[0], waypoint1.focus[0])(progress), d3.interpolateNumber(waypoint0.focus[1], waypoint1.focus[1])(progress)];
      var d3zoom = Math.pow(2, zoom) / 2 / Math.PI;
      projection.center(focus).scale(d3zoom); // Make everything the ocean in case they zoom out a lot
      ...
      d3.selectAll('.map-label').style('opacity', 0);
      d3.selectAll('.label-for-' + waypoint0.slug).style('opacity', 1 - progress);
      d3.selectAll('.label-for-' + waypoint1.slug).style('opacity', progress);
      d3.selectAll('.label-for-' + waypoint0.slug + '.label-for-' + waypoint1.slug).style('opacity', 1);
      d3.selectAll('.label-for-all').style('opacity', 1);
      positionLabels();
    }
    ...
    var currentWaypointSlug = waypoints[0].slug;
    ...
    function render() {
      ...
      var screenWidth = canvas.node().parentNode.offsetWidth;
      var screenHeight = window.innerHeight;
      projection.translate([screenWidth / 2, screenHeight / 2]);
      canvas.attr('height', screenHeight).attr('width', screenWidth);
      labelHolder.style('height', screenHeight + 'px').style('width', screenWidth + 'px');
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","canvas":"../node_modules/canvas/browser.js","./images/zoom1.jpg":"images/zoom1.jpg","./images/zoom2.jpg":"images/zoom2.jpg","./images/zoom3.jpg":"images/zoom3.jpg","./images/zoom4.jpg":"images/zoom4.jpg"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","graphic-progress.js"], null)
//# sourceMappingURL=/graphic-progress.4246f51d.map