...
(function () {
  ...
  function to_relative_percent(element, property, value) {
    ...
    var target_style_property = property; // width/height
  ...
  function animate_elements(root_element, selector_to_properties_map, transition_props) {
    Object.entries(selector_to_properties_map).forEach(function (_ref3) {
      var _ref4 = _slicedToArray(_ref3, 2),
          selector = _ref4[0],
          prop_values_map = _ref4[1];
      ...
      if (element) {
        ...
        update_element_visibility(prop_values_map['opacity'] > 0 || getComputedStyle(element).opacity > 0.001); // remove current animations, pausing elements in their current state

        anime.remove(element);

        var full_params = _objectSpread({}, transition_props, prop_values_map, {
          // this element's animated properties: width? color? ...
          targets: [element],
          complete: function complete() {
            return update_element_visibility(getComputedStyle(element).opacity > 0.001);
          }
        ...
        if (full_params.hasOwnProperty("easing")) {
          ...
          var ease = full_params["easing"].trim();
  ...
  function get_changed_properties_between_states(initial_element_state, from_state_element_state, to_state_element_state) {
     ...
     **/
    var selector_to_props = {}; // set all old state properties back to initial

    Object.entries(from_state_element_state).forEach(function (_ref7) {
      var _ref8 = _slicedToArray(_ref7, 2),
          selector = _ref8[0],
          properties = _ref8[1];

      selector_to_props[selector] = selector_to_props[selector] || {};
      Object.entries(properties).forEach(function (_ref9) {
    ...
    Object.entries(to_state_element_state).forEach(function (_ref11) {
  ...
  function transitioning_to_state(root_element, initial_properties, states_flow, now_state_name, transition_animation_time) {
     ...
     */
    var new_state_flow = states_flow[now_state_name]; // set up new listeners
    ...
    try {
      var _loop = function _loop() {
        var listener_specs = _step.value;
        ...
        function on_listener_run() {
          ...
          var next_state_element_state = states_flow[next_state_name].overrides; // get all animated properties between the two states

          var element_selector_to_changed_properties = get_changed_properties_between_states(initial_properties, this_state_element_state, next_state_element_state);
          var longest_animation_time_ms = 0;
          Object.entries(listener_specs.animations).forEach(function (_ref15) {
            var _ref16 = _slicedToArray(_ref15, 2),
                selector = _ref16[0],
                animation_specs = _ref16[1];
      ...
      for (var _iterator = new_state_flow.listeners[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        _loop();
      }
    } catch (err) {
  ...
  function load_initial_values(anima_components) {
    anima_components.forEach(function (anima_component) {
      ...
      var initial_state_name = anima_component.initial_state_name; // const initial_properties = anima_component.initial_properties;

      var initial_properties = {};
      Object.values(anima_component.states_flow).forEach(function (state_spec) {
        Object.entries(state_spec.overrides).forEach(function (_ref17) {
      ...
      Object.entries(anima_component.states_flow[initial_state_name].overrides).forEach(function (_ref19) {
  ...
  run_when_doc_ready(function () {
    return load_initial_values(anima_components);
  }); // each of these describes a timeline 

  var anima_components = [{
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","missouri_east_west.js"], null)
//# sourceMappingURL=/missouri_east_west.deb6a02d.map